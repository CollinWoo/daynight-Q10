...
a2 <- ggplot(week_Q10, aes(x = Q10)) + geom_histogram(color= "black", fill = "white") + xlim(0, 5) + labs(title = "Q10 Distribution")
ggsave("Q10 Distribution.png", a2)
b <- ggplot(week_Q10, aes(x = R2, fill=DAY_NIGHT)) + geom_histogram() + facet_wrap(~DATASET) + labs(title = "R2 By Dataset")
ggsave("R2 By Dataset.png", b)
c <- ggplot(week_Q10, aes(x = Q10, fill=DAY_NIGHT)) + geom_histogram() + xlim(0, 5) + facet_wrap(~DATASET) + labs(title = "Q10 By Dataset")
