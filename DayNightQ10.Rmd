...
SMOSfiles <- function(date){
  ...
  download.file(fileurls[1], destfile= paste0("./L03", matchfiles[1]), method = "curl") #<- this doesn't work, 403 forbidden error
  download.file(fileurls[2], destfile= paste0("./L03", matchfiles[2]), method = "curl")
  return(matchfiles)
}
