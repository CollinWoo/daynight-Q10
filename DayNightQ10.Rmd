...
SMOStifnames(c("2013/5/18", "2013/5/18", "2013/6/18", "2021/12/12", "2013/6/20", "2013/6/21"))
testFrame = data.frame(dates = c("2013/5/18", "2013/5/18", "1013/6/18", "2021/12/12", "1013/6/20", "1013/6/21"))
...
R2distr <- geom_histogram(color= "black", fill = "white") + geom_vline(aes(xintercept = median(R2)), linetype="dashed", color="red")
  
monthR2 <- ggplot(week_Q10, aes(x = R2)) + R2distr + labs(title = "R2 Distribution") + geom_text(aes(label = paste("Median =", round(median(R2), digits=3))), x = 0.15, y = 400, size = 3)
ggsave("R2 Distribution.png", monthR2)

yearR2 <- ggplot(year_Q10, aes(x = R2)) + R2distr + labs(title = "Year R2 Distribution") + geom_text(aes(label = paste("Median =", round(median(R2), digits=3))), x = 0.3, y = 20, size = 3)
