...
print(d)
print(d2)
print(ggplot(week_Q10 %>% filter(Rs_Rh == "Rs", DEPTH == 5), aes(MON_YEAR, Q10, color = DAY_NIGHT, group = paste(YEAR, DAY_NIGHT))) + geom_point() + ylim(0,5) + facet_wrap(~DATASET, scales = "free_x") + labs(title = "Rs Variation by Day/Night"))

print(ggplot(week_Q10 %>% filter(Rs_Rh == "Rh", DEPTH == 5), aes(MON_YEAR, Q10, color = DAY_NIGHT, group = paste(YEAR, DAY_NIGHT))) + geom_point() + ylim(0,5) + facet_wrap(~DATASET+DEPTH, scales = "free_x") + labs(title = "Rh Variation by Day/Night") + 
theme(
