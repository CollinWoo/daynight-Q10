...
testFrame = data.frame(dates = c("2013/5/18", "2013/5/18", "2013/6/18", "2021/12/12", "2013/6/20", "2013/6/21"))
...
bind_rows(year_Q10, .id = "ID") %>% 
  filter(!is.na(Q10), is.finite(Q10)) %>% 
  dplyr::select(DATASET, YEAR, DAY_NIGHT, Rs_Rh, DEPTH:RESP, N) %>% 
...
bind_rows(yearonly_Q10, .id = "ID") %>% 
  filter(!is.na(Q10), is.finite(Q10)) %>% 
  dplyr::select(DATASET, YEAR, DEPTH:RESP, SURFACE, SUBSURFACE, N) %>% 
  arrange(DATASET, DEPTH, YEAR) %>%
  left_join(MA_set, by = "DATASET") -> 
  yearonly_Q10
