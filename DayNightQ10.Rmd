...
monthR2 <- ggplot(week_Q10, aes(x = R2)) + geom_histogram(color= "black", fill = "white") + labs(title = "R2 Distribution") + geom_vline(aes(xintercept = median(R2)), linetype="dashed", color="red") + geom_text(aes(label = paste("Median =", round(median(R2), digits=3))), x = 0.15, y = 400, size = 3)
ggsave("R2 Distribution.png", monthR2)

yearR2 <- ggplot(year_Q10, aes(x = R2)) + geom_histogram(color= "black", fill = "white") + labs(title = "Year R2 Distribution") + geom_vline(aes(xintercept = median(R2)), linetype="dashed", color="red") + geom_text(aes(label = paste("Median =", round(median(R2), digits=3))), x = 0.3, y = 20, size = 3)
...
testFrame %>% left_join(testMoisture, by="Surface.File")
print(testFrame)
extractSMOS(c("./LO3_tif/20100110_20100112.as1.tif"), 30, 60)
SMOSfiles(c("2012/5/18", "2012/5/18", "2012/5/18","2012/5/19", "2012/5/18"))
